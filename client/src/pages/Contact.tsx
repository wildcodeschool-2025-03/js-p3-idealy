...
function Contact() {
  ...
  return (
    <main className="max-w-lg mx-auto px-4 py-6">
      <h1 className="text-2xl font-[atkinson] mt-6 mb-6 bg-[#ffbd2e] rounded-md px-4 py-2 text-center w-fit mx-auto">
        Contactez-nous
      </h1>
      ...
      >
        ...
        <div className="flex justify-center">
          <button
            type="submit"
            className="bg-[#28c940] px-6 py-4 rounded font-bold focus:outline-none focus:ring-2"
