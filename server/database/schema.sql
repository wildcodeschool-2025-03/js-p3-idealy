...
INSERT INTO Idea (title, description, deadline, timestamp, statut_id) VALUES
("Machine en mauvais état", "La machine à café actuelle est souvent en panne et engendre de nombreuses frustrations parmi les employés. Il serait bénéfique de la remplacer ou de la faire réparer durablement. Cela améliorerait le moral et la productivité du personnel.", "2024-12-12", "2024-09-27", 2),
("Poste de travail ergonomique", "Les postes de travail ne sont pas adaptés aux besoins ergonomiques des employés, ce qui peut provoquer des douleurs ou troubles musculo-squelettiques. Une révision de l’agencement des bureaux, chaises et écrans est proposée afin d'améliorer le confort et la santé au quotidien.", "2025-08-04", "2025-05-16", 1),
("Réduction des déchets plastiques", "L'utilisation excessive de plastique à usage unique dans l'entreprise représente un impact environnemental important. Il serait pertinent d’introduire des alternatives durables et de sensibiliser le personnel aux gestes écoresponsables pour réduire notre empreinte écologique.", "2025-08-15", "2025-07-10", 1),
("Application mobile interne", "La communication entre les équipes pourrait être largement améliorée par une application mobile dédiée. Elle permettrait de centraliser les échanges, calendriers, documents partagés et notifications importantes dans un outil unique, accessible à tout moment.", "2026-03-06", "2025-12-17", 1),
("Optimisation des horaires", "Le système actuel d’horaires rigides ne convient pas à tous les services. Une organisation plus souple, avec possibilité de télétravail ou de plages horaires aménagées, pourrait favoriser une meilleure gestion du temps et un équilibre vie professionnelle/personnelle.", "2025-03-20", "2024-11-01", 2),
("Nouveau processus de feedback", "Le feedback est actuellement rare et peu structuré. Mettre en place un processus de retour d'information régulier, anonyme et constructif permettrait d'améliorer la transparence, de valoriser les efforts des employés et de corriger rapidement les points bloquants.", "2025-05-20", "2024-12-12", 3),
("Campagne bien-être au travail", "Le stress et la fatigue ont un impact croissant sur la motivation des équipes. Une campagne bien-être incluant des séances de yoga, de méditation, des conférences et des activités sociales pourrait améliorer la santé mentale et renforcer la cohésion interne.", "2026-02-07", "2025-09-12", 1),
("Automatisation du reporting", "Les rapports hebdomadaires sont chronophages et souvent réalisés manuellement. Automatiser la génération de ces documents permettrait de gagner un temps précieux, de fiabiliser les données et de se concentrer sur l’analyse plutôt que la collecte d’informations.", "2025-05-04", "2024-11-10", 3),
...
("Formation continue des équipes", "Le développement des compétences est essentiel à l’évolution de l’entreprise. Il est proposé de créer un programme de formation continue, en ligne ou en présentiel, permettant à chacun d’acquérir de nouvelles aptitudes et de s’adapter aux évolutions du marché.", "2025-01-13", "2024-08-31", 3),
("Révision des fournisseurs", "Les coûts liés à certains fournisseurs semblent excessifs sans justification claire. Une étude comparative et une renégociation des contrats pourraient générer des économies importantes tout en maintenant, voire en améliorant, la qualité des services et produits.", "2025-03-08", "2024-11-17", 2),
...
("Covoiturage entreprise", "Beaucoup d'employés se déplacent seuls en voiture, ce qui augmente les coûts et l’empreinte carbone. La mise en place d’un système de covoiturage structuré favoriserait les trajets partagés, réduirait le trafic et améliorerait l’ambiance entre collègues.", "2025-05-08", "2024-11-19", 3),
("Centralisation documentation", "La documentation est éparpillée sur différents supports, ce qui complique l’accès à l’information. Une plateforme centralisée et bien organisée permettrait un gain de temps significatif, une meilleure traçabilité et un accès équitable pour tous les services.", "2025-03-09", "2024-09-30", 2),
("Réduction bruit open space", "Le bruit constant dans les open spaces nuit à la concentration et à l'efficacité. Installer des panneaux acoustiques, proposer des casques antibruit et aménager des espaces silencieux pourrait grandement améliorer le confort sonore des collaborateurs.", "2026-04-16", "2025-11-16", 1),
("Outil de suivi de projet", "Le suivi des projets est actuellement dispersé entre plusieurs outils non synchronisés. Un logiciel unique, simple et intuitif, permettrait de mieux planifier, suivre les étapes, collaborer efficacement et respecter les délais, tout en gardant une trace claire de l’avancement.", "2025-11-19", "2025-06-17", 1);
